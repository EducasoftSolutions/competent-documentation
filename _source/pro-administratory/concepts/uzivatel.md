...
deaktivaci účtu nebo při automatickém přiřazování aktivit – akce vždy míří na
...
- **Aktivní** – uživatel se může přihlásit a pracovat v systému podle svých
  oprávnění.
- **Deaktivovaný** – přihlášení není možné; uživatelský záznam zůstává v systému
  zachován včetně veškeré historie.

Jiné stavy účtu neexistují. Deaktivaci nastavuje přepínač **Účet deaktivován**
v zakládacím nebo editačním modálu uživatele; záznam se z databáze nemaže.
...
Deaktivace probíhá nastavením stavu **Deaktivovaný** (přepínač Účet deaktivován). Záznam se z databáze
