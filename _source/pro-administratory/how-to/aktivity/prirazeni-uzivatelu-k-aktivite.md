...
![Detail aktivity s prázdným tabem Uživatelé](_media/prirazeni-uzivatelu-k-aktivite/01-tab-uzivatele-prazdny.png)
...
![Panel Výběr účastníků s bočním seznamem uživatelů](_media/prirazeni-uzivatelu-k-aktivite/02-vyber-ucastniku.png)
...
![Panel s vybranými uživateli](_media/prirazeni-uzivatelu-k-aktivite/03-vybrani-uzivatele.png)
...
![Krok Nastavení plnění s poli dat přístupu](_media/prirazeni-uzivatelu-k-aktivite/04-nastaveni-plneni-data.png)
...
![Zapnutá sekce Periodické nastavení](_media/prirazeni-uzivatelu-k-aktivite/05-periodicke-nastaveni-zapnuto.png)

Podrobný popis voleb periodicity najdete na stránce [Periodické nastavení](../../reference/periodicke-nastaveni.md). Pokud periodicitu nepotřebujete, sekci nechte vypnutou.
...
![Tab Uživatelé s přiřazenými uživateli](_media/prirazeni-uzivatelu-k-aktivite/06-prirazeni-ulozeno.png)
...
- [Periodické nastavení](../../reference/periodicke-nastaveni.md)
