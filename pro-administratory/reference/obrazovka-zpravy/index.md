...
Obrazovka **Zprávy** zobrazuje všechny zprávy v systému. Stejná hodnota stavu se přitom zobrazuje jinak podle typu zprávy; princip popisuje [Zprávy: model a principy](https://educasoftsolutions.github.io/competent-documentation/pro-administratory/concepts/zpravy/index.md).
...
| **Typ**                | Typ zprávy; nabízí filtrování výběrem z dropdownu. Přehled typů popisuje [Zprávy: model a principy](https://educasoftsolutions.github.io/competent-documentation/pro-administratory/concepts/zpravy/index.md).                                            |
...
| **Stav**               | Aktuální stav zprávy; nabízí filtrování výběrem z dropdownu. Zobrazená hodnota závisí na typu zprávy – podrobně viz [Zprávy: model a principy](https://educasoftsolutions.github.io/competent-documentation/pro-administratory/concepts/zpravy/index.md). |
...
| Pole           | Popis                                                                                                                                                                                                                                                       |
| -------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Typ zprávy** | Dropdown s placeholderem „-- vyberte typ --". Nabízí typy zpráv, které lze vytvořit ručně; jejich přehled je součástí [Zprávy: model a principy](https://educasoftsolutions.github.io/competent-documentation/pro-administratory/concepts/zpravy/index.md). |
...
| **Typ zprávy**          | Typ dané zprávy, viz [Zprávy: model a principy](https://educasoftsolutions.github.io/competent-documentation/pro-administratory/concepts/zpravy/index.md).                                                                                                                               |
...
| **Stav**                | Aktuální stav zprávy, s možností změny. Zobrazená hodnota závisí na typu zprávy – kontext vysvětluje [Zprávy: model a principy](https://educasoftsolutions.github.io/competent-documentation/pro-administratory/concepts/zpravy/index.md).                                               |
| **Sledující**           | Uživatelé sledující danou zprávu.                                                                                                                                                                                                                                                        |
| **Předmět**             | Předmět zprávy.                                                                                                                                                                                                                                                                          |
| **Zpráva**              | Text zprávy.                                                                                                                                                                                                                                                                             |
| **Notifikace e-mailem** | Přepínač, který určuje, zda se o zprávě odešle i samostatná e-mailová notifikace. Vztah mezi zprávami a e-mailovými notifikacemi popisuje [E-mailové notifikace](https://educasoftsolutions.github.io/competent-documentation/pro-administratory/concepts/emailove-notifikace/index.md). |
...
- [Zprávy: model a principy](https://educasoftsolutions.github.io/competent-documentation/pro-administratory/concepts/zpravy/index.md)
