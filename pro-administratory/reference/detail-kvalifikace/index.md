...
Nad seznamem uživatelů jsou k dispozici dvě akce pro přiřazení kvalifikace:

- **Přiřadit uživateli** – přiřazení kvalifikace jednotlivému uživateli.
- **Přiřadit skupiny** – přiřazení kvalifikace celé uživatelské skupině.
...
| Položka                 | Popis                                                                                                                                                                                                                                                                                                       |
| ----------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Délka platnosti**     | Určuje, jak dlouho zůstává splněná kvalifikace platná. K dispozici jsou tři volby: **Neomezená platnost** (kvalifikace nikdy neexpiruje), **Do termínu** (platnost končí k pevně zadanému datu) a **Od data splnění** (platnost se počítá jako počet **Dnů** od okamžiku, kdy uživatel kvalifikaci splnil). |
...
Podmínky nejsou automatické vyhodnocení
...
Přesný výpočet data expirace nebo termínu nad rámec tří popsaných režimů platnosti (Neomezená platnost / Do termínu / Od data splnění) tato reference neuvádí.
...
- [Kvalifikace (koncept)](https://educasoftsolutions.github.io/competent-documentation/pro-administratory/concepts/kvalifikace/index.md)
