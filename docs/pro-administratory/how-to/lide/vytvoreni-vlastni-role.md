...
![Obrazovka Nastavení → Role s přepínačem Zobrazit systémové role a kulatým tlačítkem plus](_media/vytvoreni-vlastni-role/01-obrazovka-role.png)
...
![Modál Název nové role s polem Název a tlačítky Zrušit a Vytvořit roli](_media/vytvoreni-vlastni-role/02-modal-nova-role.png)
...
![Editor oprávnění nové role se záhlavím podle zadaného názvu, záložkami Práva, Vazby, Nastavení a rozšířenou lištou tlačítek](_media/vytvoreni-vlastni-role/03-po-vytvoreni.png)

!!! note "Role zatím není uložena"
...
![Záložka Práva s maticí oprávnění: vlevo kategorie entit, vpravo konkrétní oprávnění vybrané kategorie](_media/vytvoreni-vlastni-role/04-matice-opravneni.png)

Podrobný přehled kategorií oprávnění a jejich vzájemných závislostí (například že akce jako **Upravit** vyžadují i oprávnění **Číst**) najdete v referenci [Přehled rolí a oprávnění](../../reference/prehled-roli-a-opravneni.md#kategorie-opravneni).
...
- [Přiřazení role uživateli](prirazeni-role-uzivateli.md)
