...
Popis toho, jak mechanismus přiřazení dle skupin funguje, naleznete na stránce [Přiřazení dle skupin: mechanismus a principy](../concepts/prirazeni-dle-skupin.md).
...
!!! warning "Pravidla s periodicitou a ukončení"
...
- [Přiřazení dle skupin: mechanismus a principy](../concepts/prirazeni-dle-skupin.md)
