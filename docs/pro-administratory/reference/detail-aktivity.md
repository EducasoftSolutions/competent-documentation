...
| Pole | Popis |
|---|---|
| **Typ spouštění** | Určuje způsob spuštění aktivity (např. Scorm kurz, PDF soubor, Url adresa, Video, Vložený kód, Formulář, iTrivio, Nahrání souborů, Žádný a další). Podrobnosti viz [Vytvoření SCORM aktivity](../how-to/aktivity/vytvoreni-scorm-aktivity.md). |
...
| **Nová verze** | Umožní zvýšit číslo verze obsahu, například při výměně SCORM balíčku. Podrobnosti viz [Vytvoření SCORM aktivity](../how-to/aktivity/vytvoreni-scorm-aktivity.md). |
