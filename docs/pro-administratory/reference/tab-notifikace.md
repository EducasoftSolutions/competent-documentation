...
| Šablona | Rozbalovací seznam s vyhledáváním | Výběr skupiny e-mailových šablon. Správa šablon je dostupná na [obrazovce Šablony e-mailů](obrazovka-sablony-emailu.md). |
...
- [Obrazovka Šablony e-mailů](obrazovka-sablony-emailu.md) – správa e-mailových šablon
